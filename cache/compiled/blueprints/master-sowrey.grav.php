...
return [
    ...
    'timestamp' => 1632622038,
    'checksum' => '5d52bed7a9fd8545afc5df83b79abe9d',
    'files' => [
        ...
        'user/themes' => [
            'themes/medium' => [
                'file' => 'user/themes/medium/blueprints.yaml',
                'modified' => 1632164058
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'themes.medium.default_lang' => [
                ...
                'name' => 'themes.medium.default_lang',
                'validation' => 'loose'
            ],
            'themes.medium.infinite_scroll' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.medium.infinite_scroll',
                'validation' => 'loose'
            ],
            'themes.medium.analytics' => [
                'type' => 'text',
                'size' => 'medium',
                ...
                'name' => 'themes.medium.analytics',
                'validation' => 'loose'
            ],
            'themes.medium.social' => [
                'type' => '_parent',
                'name' => 'themes.medium.social',
                'form_field' => false
            ],
            'themes.medium.social.twitter' => [
                'type' => 'text',
                'size' => 'medium',
                'label' => 'Twitter',
                'default' => '@mblode',
                ...
                'name' => 'themes.medium.social.twitter',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                'medium' => [
                    'default_lang' => 'themes.medium.default_lang',
                    'infinite_scroll' => 'themes.medium.infinite_scroll',
                    'analytics' => 'themes.medium.analytics',
                    'social' => [
                        'twitter' => 'themes.medium.social.twitter'
                    ]
                ],
                'quark' => [
