...
return [
    ...
    'filename' => '/Users/geoff/Sites/sowrey.grav/user/pages/02.stories/novels/banshee/the-banshee-chapter-32/item.md',
    'modified' => 1632682626,
    'data' => [
        'header' => [
...
#  last_modified: true
',
        'markdown' => 'The wind howled. It blew from all directions, putting sand and dust in any corner or crevice that hadn’t already received an allotment. The sand drifted in small dunes, until the dunes pressed into a barrier, forcing them to slither about to find a new route. It piled up, flattening out a landscape that had once been revered for its rocky sharpness, it’s harsh reliefs. 
