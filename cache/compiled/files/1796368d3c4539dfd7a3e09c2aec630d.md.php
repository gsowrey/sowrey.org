...
return [
    ...
    'filename' => '/Users/geoff/Sites/sowrey.grav/user/pages/02.stories/soundtrack-of-my-life/14.diamonds-on-the-soles-of-her-shoes-by-paul-simon/item.md',
    'modified' => 1632682626,
    'data' => [
        'header' => [
...
#  last_modified: true
',
        'markdown' => 'Paul Simon released *Graceland* just as I started high school. Quite a few of my classmates loved the video for *You Can Call Me Al*, especially the version that featured Chevy Chase. Of the videos, I much preferred *Boy In The Bubble* because of its side-scrolling animation, reminiscent of both video games and *Monty Python* (I also preferred the lyrics of *Boy In The Bubble*).
