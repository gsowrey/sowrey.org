...
class __TwigTemplate_e0fb029f8e91e3086b42adf0f9afc4153f4d88b4df631cc8460b444ece5df14b extends \Twig\Template
{
...
<p>";
        // line 4
        $context["my_collection"] = $this->getAttribute(($context["page"] ?? null), "collection", [0 => ["items" => ["@root.descendants" => ""], "limit" => 10, "order" => ["by" => "folder", "dir" => "asc"]]], "method");
        // line 5
        echo twig_escape_filter($this->env, sizeof(($context["my_collection"] ?? null)), "html", null, true);
        echo "</p>
<p>";
        // line 6
...
";
            // line 8
            echo twig_escape_filter($this->env, $this->getAttribute($context["c"], "summary", []), "html", null, true);
            echo "</p>
<p>";
        }
...
<li><a href=\"http://sowrey.wp/novels/the-banshee-chapter-34/\">The Banshee: Chapter 34</a> Posted in: <a href=\"http://sowrey.wp/category/novels/\">Novels</a>, <a href=\"http://sowrey.wp/category/science-fiction/\">Science Fiction</a>, <a href=\"http://sowrey.wp/category/novels/the-banshee/\">The Banshee</a> - Jo and Robert sew together a wolf out of sheep's clothing.</li>
    ...
    {
        return array (  59 => 9,  51 => 8,  47 => 7,  41 => 6,  37 => 5,  35 => 4,  30 => 1,);
    }
...
<p>That’s what this place is all about: I want to tell new stories. And I hope you’ll join me on this journey.</p>
<h2>Recent Stories</h2>
<p>{% set my_collection = page.collection({ items: {'@root.descendants':''}, 'limit': 10, 'order': {'by': 'folder', 'dir': 'asc'}}) %}
{{ sizeof(my_collection)}}</p>
<p>{% for c in my_collection %}</p>
<p>{{ c.title }}<br>
{{ c.summary }}</p>
<p>{% endfor %}</p>
<ul>
