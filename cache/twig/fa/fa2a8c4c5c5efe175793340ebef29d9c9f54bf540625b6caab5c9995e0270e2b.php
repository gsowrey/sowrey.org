...
class __TwigTemplate_b3f5c0c4bc7ab8c32742ad16896d8a70aba095fa8169baeab740844ba4997800 extends \Twig\Template
{
...
<p>";
        // line 4
        $context["options"] = ["items" => ["@root.descendants" => ""], "order" => ["by" => "folder", "dir" => "asc"]];
        // line 5
...
<p>That’s what this place is all about: I want to tell new stories. And I hope you’ll join me on this journey.</p>
<h2>Recent Stories</h2>
<p>{% set options = { items: {'@root.descendants':''}, 'order': {'by': 'folder', 'dir': 'asc'}} %}
